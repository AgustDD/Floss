...
Specifically, in the TS-TCC and TS2vec, we first identify time series with periodic variations and then extract their representations. However, in the Informer and PatchTST baselines, we extract representations that capture periodic variations from the entire set of features.
