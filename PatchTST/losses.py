# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 18:16:15 2022
...
def hierarchical_contrastive_loss(z1, z2, alpha=0.5, temporal_unit=0, beta=0.3, trans_type='dct'):
...
def wavelet_loss(z1, z2, pycwt):
    o1 = z1.permute( [0, 2, 1])
    o2 = z2.permute( [0, 2, 1])
    return torch.mean(torch.abs(torch.abs(pycwt(o1)) - torch.abs(pycwt(o2))))