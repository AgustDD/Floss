...
from models.model import base_Model, base_Model2
...
#python main.py --experiment_description exp1 --run_description run_2 --seed 666 --training_mode train_linear --selected_dataset HAR
...
model2 = base_Model2(configs).to(device)
...
# Trainer
Trainer(model,model2, temporal_contr_model, model_optimizer, temporal_contr_optimizer, train_dl, valid_dl, test_dl, device, logger, configs, experiment_log_dir, training_mode)
