...
data_parser = {
    ...
    'electricity':{'data':'electricity.csv','T':'OT','M':[321,321,321],'S':[1,1,1],'MS':[7,7,1]},
    'illness':{'data':'national_illness.csv','T':'OT','M':[7,7,7],'S':[1,1,1],'MS':[7,7,1]},
    'exchange_rate':{'data':'exchange_rate.csv','T':'OT','M':[8,8,8],'S':[1,1,1],'MS':[7,7,1]},
    'weather':{'data':'weather.csv','T':'OT','M':[21,21,21],'S':[1,1,1],'MS':[7,7,1]},
}
